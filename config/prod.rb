...
set :vpc_deploy_config do
  {
    ...
    deployment_description: 'vpc - Production'
  }
end
...
set :db_deploy_config do
  {
    ...
    deployment_description: 'db - Production'
  }
end
...
set :app_deploy_config do
  {
    ...
    deployment_description: 'app - Production'
  }
end
